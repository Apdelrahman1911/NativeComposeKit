...
public fun NativePopover(
    ...
    PlatformNativePopover(visible, onDismissRequest, modifier, alignment, testTag, anchor, content)
}
 ...
 * typography (`NativeCard` reads `LocalNativeSurface`) so it looks native-appropriate in light and dark.
 */
@Composable
