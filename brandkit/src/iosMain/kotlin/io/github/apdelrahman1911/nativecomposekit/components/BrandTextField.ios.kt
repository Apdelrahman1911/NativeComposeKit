...
import io.github.apdelrahman1911.nativecomposekit.components.model.BrandClearButtonMode
...
import io.github.apdelrahman1911.nativecomposekit.components.model.BrandKeyboardAccessory
import io.github.apdelrahman1911.nativecomposekit.components.model.BrandKeyboardAccessoryStyle
import io.github.apdelrahman1911.nativecomposekit.components.model.BrandKeyboardAppearance
...
private fun BrandImeAction.toReturnKeyType(): UIReturnKeyType = when (this) {
    BrandImeAction.Default -> UIReturnKeyType.UIReturnKeyDefault
    BrandImeAction.Done -> UIReturnKeyType.UIReturnKeyDone
    BrandImeAction.Go -> UIReturnKeyType.UIReturnKeyGo
    BrandImeAction.Next -> UIReturnKeyType.UIReturnKeyNext
    BrandImeAction.Search -> UIReturnKeyType.UIReturnKeySearch
    BrandImeAction.Send -> UIReturnKeyType.UIReturnKeySend
}

private fun BrandCapitalization.toAutocapitalization(): UITextAutocapitalizationType = when (this) {
    BrandCapitalization.None -> UITextAutocapitalizationType.UITextAutocapitalizationTypeNone
    BrandCapitalization.Characters -> UITextAutocapitalizationType.UITextAutocapitalizationTypeAllCharacters
    BrandCapitalization.Words -> UITextAutocapitalizationType.UITextAutocapitalizationTypeWords
    BrandCapitalization.Sentences -> UITextAutocapitalizationType.UITextAutocapitalizationTypeSentences
}
...
private fun BrandKeyboardAppearance.toKeyboardAppearance(): UIKeyboardAppearance = when (this) {
    BrandKeyboardAppearance.Default -> UIKeyboardAppearanceDefault
    BrandKeyboardAppearance.Light -> UIKeyboardAppearanceLight
    BrandKeyboardAppearance.Dark -> UIKeyboardAppearanceDark
}

private fun BrandTextContentType.toUITextContentType(): String? = when (this) {
    BrandTextContentType.Name -> UITextContentTypeName
    BrandTextContentType.EmailAddress -> UITextContentTypeEmailAddress
    BrandTextContentType.Username -> UITextContentTypeUsername
    BrandTextContentType.Password -> UITextContentTypePassword
    BrandTextContentType.NewPassword -> UITextContentTypeNewPassword
    BrandTextContentType.OneTimeCode -> UITextContentTypeOneTimeCode
    BrandTextContentType.TelephoneNumber -> UITextContentTypeTelephoneNumber
    BrandTextContentType.PostalCode -> UITextContentTypePostalCode
    BrandTextContentType.FullStreetAddress -> UITextContentTypeFullStreetAddress
}

private fun BrandClearButtonMode.toViewMode(): UITextFieldViewMode = when (this) {
    BrandClearButtonMode.Never -> UITextFieldViewMode.UITextFieldViewModeNever
    BrandClearButtonMode.WhileEditing -> UITextFieldViewMode.UITextFieldViewModeWhileEditing
    BrandClearButtonMode.UnlessEditing -> UITextFieldViewMode.UITextFieldViewModeUnlessEditing
    BrandClearButtonMode.Always -> UITextFieldViewMode.UITextFieldViewModeAlways
}
...
/**
 * iOS BrandTextField. Single-line → `UITextField`; multiline → `UITextView` (with a placeholder
...
private fun makeAccessory(
    accessory: BrandKeyboardAccessory,
    colors: BrandFieldColors,
    target: NSObject,
    action: COpaquePointer?,
): UIView = when (accessory.style) {
    BrandKeyboardAccessoryStyle.FullWidthBar -> makeDoneBar(
        accessory.doneText,
    ...
    BrandKeyboardAccessoryStyle.Toolbar -> makeDoneToolbar(
        accessory.doneText,
        colors.focusedBorder.toUIColor(),
        target,
        action,
