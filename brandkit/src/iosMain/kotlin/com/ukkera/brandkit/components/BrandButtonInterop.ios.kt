 ...
 * show together in their true positions — no forced-RTL hack. Reused by BrandButton, BrandIconButton,
 * and BrandSplitButton (so they stay visually consistent).
 */
@OptIn(ExperimentalForeignApi::class)
internal class BrandButtonViews {
