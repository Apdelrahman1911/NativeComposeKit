 ...
 *
 * `BrandPageControl(pageCount = covers.size, currentPage = page)`
 */
@Composable
public fun BrandPageControl(
    pageCount: Int,
    currentPage: Int,
...
@Composable
internal expect fun PlatformBrandPageControl(
    pageCount: Int,
    currentPage: Int,
    modifier: Modifier,
