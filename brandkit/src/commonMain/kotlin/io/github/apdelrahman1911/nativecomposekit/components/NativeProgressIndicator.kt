...
public enum class NativeProgressKind { Circular, Linear }
 ...
 *
 * `NativeProgressIndicator()` (spinner) · `NativeProgressIndicator(kind = Linear, progress = downloaded)`
 */
@Composable
public fun NativeProgressIndicator(
    modifier: Modifier = Modifier,
    kind: NativeProgressKind = NativeProgressKind.Circular,
    progress: Float? = null,
    color: Color? = null,
    ...
    PlatformNativeProgressIndicator(
        modifier = modifier,
        kind = kind,
...
@Composable
internal expect fun PlatformNativeProgressIndicator(
    modifier: Modifier,
