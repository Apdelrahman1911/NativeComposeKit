 ...
 * [NativeCheckbox]'s nullable convention (the kit's "nullable callback = optionally interactive" idiom).
 */
@Composable
...
@Composable
internal expect fun PlatformNativeToggle(
    checked: Boolean,
