 ...
 * [NativeTheme.tokens]. Swap by providing a different instance to [LocalNativeTokens].
 */
@Immutable
public data class NativeTokens(
...
public val LocalNativeTokens: ProvidableCompositionLocal<NativeTokens> = staticCompositionLocalOf { NativeTokens() }
