 ...
 *
 * A hosted screen brings NO Scaffold of its own (the nav shell owns chrome and the appearance scope owns
 * the background) — it is a plain scrollable column, the pattern every hosted screen follows.
 */
@Composable
